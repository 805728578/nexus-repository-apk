 ...
 */
package org.sonatype.nexus.plugins.apk.internal.cleanup;
...
/**
 * Defines which cleanup policy fields to display for Apk.
 *
 * @since 3.28
 */
@Named(ApkFormat.NAME)
@Singleton
public class ApkCleanupPolicyConfiguration
